...
DATA: 19/04/2010
----------------------------------------------------------------------------------------------------------------------
exec pr_inclui_cliente_exercito 1, null, '2012-12-01', null
...
begin
   ...
   clt_data_atualizacao_margem, orgav_codigo, uni_codigo, fil_codigo, tst_codigo, clt_margem_consignavel )
   ...
   @orgav_codigo, @uni_codigo, 1, 1, margem
